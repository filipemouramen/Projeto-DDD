...
namespace Projeto.Data.Repository
{
    public class MatriculaRepository(IConfiguration configuration) : IMatriculaRepository
    {
        ...
        {
            var sql = @"INSERT INTO desenvolvimento.Matricula (idAluno, idCurso, DataMatricula, Ativo) VALUES (@idAluno, @idCurso, @DataMatricula, @Ativo)";
        ...
        {
            var sql = @"SELECT idAluno, idCurso, DataMatricula, Ativo FROM desenvolvimento.Matricula WHERE idAluno = @idAluno";
        ...
        public List<Matricula> ObterPorCurso(int IDcurso)
        {
            ...
            var sql = @"SELECT idAluno, idCurso, DataMatricula, Ativo FROM desenvolvimento.Matricula WHERE idCurso = @idCurso";
        ...
        public List<Matricula> ObterTodos()
        {
            ...
            var sql = "SELECT idAluno, idCurso, DataMatricula, Ativo FROM desenvolvimento.Matricula";
